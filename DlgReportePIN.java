 ...
 * @author 18Z99LA
 */
public class DlgReportePIN extends javax.swing.JDialog {

    /**
     * Creates new form DlgReportes
     */
    public DlgReportePIN(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tblReportea.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombre_pin", "Telefono", "Correo", "Monto"
            }
        ));
        ...
        jLabel1.setText("REPORTES PINES");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (m.getRowCount() == 0) {
            ...
            for (Total c : to) {
                ...
                if (c instanceof Pines) {
                    rowData[0] = ((Pines) c).getId();
                    rowData[1] = ((Pines) c).getNompin();
                    rowData[2] = ((Pines) c).getNumtelf();
                    rowData[3] = ((Pines) c).getCorreo();
                    rowData[4] = ((Pines) c).getMonto();
                    m.addRow(rowData);
                }
            }
        }
